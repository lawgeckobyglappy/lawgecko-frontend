<template>
    <div>
        <div v-show="!mobile" class="flex flex-row justify-end mb-3">
            <TheButton :text="previewButtonText" @click="changePreviewMode" class="mr-3" />
            <TheButton text="Save" />
        </div>
        <div class="mb-10"></div>
    </div>
    <div :class="{ 'preview-mode': isPreviewMode }">
        ...
        <div class="form">
            <form>
                ...
                <div v-show="mobile" class="flex mt-10 flex-row justify-end mb-3">
                    <TheButton text="Preview" @click.prevent="changePreviewMode" class="mr-3" />
                    <TheButton text="Save" />
                </div>
            </form>
        </div>
    ...
    <div v-if="isPreviewMode" class="mt-10">
        <AssessmentPreview />
    </div>
</template>
<script>
